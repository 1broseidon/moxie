...
- Progress stall timeout disabled by default to avoid false positives on long-running subagent tasks
- Docs refreshed: home quick-start, service notes, Windows scheduler status, schedule rollout cleanup
